# Plesk Preview Audit - BTP DatastAIsis

Date: 2026-06-03

Purpose: stabilize Plesk preview rendering before deployment so the site loads consistently at the real domain and at preview URLs such as `/plesk-site-preview/datastaisis.cloudexcelon.com/`.
...
- Preview path simulation: helper output must include `/plesk-site-preview/datastaisis.cloudexcelon.com/` for preview requests.
