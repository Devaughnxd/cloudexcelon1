# Content Source Policy - BTP TechAdvisors
...
## TechAdvisors Content Boundaries

- Service lane: Strategic advisory and client engagement for complex technology decisions.
- Approved service capabilities: Technology strategy, Vendor-neutral advisory, Digital transformation planning, IT roadmap development, Solution evaluation, Cost optimization.
- Approved outcome language: Clearer decisions, Reduced technology risk, Better executive alignment, Practical next steps.
- Approved deliverable language: Discovery brief, Options and tradeoff analysis, Roadmap recommendations, Vendor-neutral scorecard, Execution alignment plan.
