...
foreach ($brands as $slug => $brand) {
    ...
    write_file($siteRoot . '/docs/plesk-preview-audit.md', pleskPreviewAudit($slug, $brand));
...
function imageBlock(string $file, string $alt, bool $lazy = false): string
{
    ...
    return '<figure class="visual-card"><img src="<?= e(asset(\'images/' . h($file) . '\')) ?>" alt="' . h($alt) . '" width="880" height="560" decoding="async"' . $loading . '></figure>';
}
...
SVG,
  ...
  <g class="motif advisory" transform="translate(342 150)">
    ...
    <rect x="42" y="26" width="92" height="28" rx="6" fill="#ffffff" fill-opacity=".1"/><rect x="42" y="86" width="126" height="28" rx="6" fill="#ffffff" fill-opacity=".1"/><rect x="42" y="146" width="168" height="28" rx="6" fill="#ffffff" fill-opacity=".1"/>
  </g>
SVG,
        'SecuriSCOPE' => <<<SVG
  <g class="motif security" transform="translate(348 142)">
    ...
    <path d="M135 48 L203 76 V121 C203 166 174 196 135 214 C96 196 67 166 67 121 V76 Z" fill="#ff3b30" fill-opacity=".18" stroke="$accent" stroke-width="4"/>
...
SVG,
  ...
  <g class="motif ops" transform="translate(338 138)">
    ...
    <rect x="24" y="94" width="124" height="126" rx="12" fill="#2aa8ff" fill-opacity=".14" stroke="$accent"/>
    <rect x="166" y="94" width="116" height="32" rx="8" fill="$accent2"/><rect x="166" y="142" width="116" height="32" rx="8" fill="#ffffff" fill-opacity=".12"/><rect x="166" y="190" width="116" height="32" rx="8" fill="#ffffff" fill-opacity=".12"/>
...
SVG,
  ...
  <g class="motif cloud" transform="translate(332 136)">
    <path d="M94 112 C96 70 130 42 173 50 C192 20 246 28 260 69 C300 72 326 101 326 138 C326 179 295 206 250 206 H102 C58 206 28 178 28 139 C28 104 54 113 94 112Z" fill="$accent" fill-opacity=".16" stroke="$accent" stroke-width="4"/>
...
<svg xmlns="http://www.w3.org/2000/svg" width="880" height="560" viewBox="0 0 880 560" role="img" aria-labelledby="title desc">
  ...
  <g filter="url(#s)" font-family="Segoe UI, Arial">
    ...
    <text x="172" y="91" font-size="18" font-weight="850" fill="#fff">$heading</text>
    ...
    <g>
      <rect x="58" y="170" width="192" height="66" rx="16" fill="#ffffff" fill-opacity=".09" stroke="$accent" stroke-opacity=".65"/>
      <circle cx="92" cy="203" r="15" fill="$accent"/><text x="118" y="209" font-size="15" font-weight="850" fill="#fff">$l0</text>
      <rect x="58" y="262" width="210" height="66" rx="16" fill="#ffffff" fill-opacity=".09" stroke="$accent2" stroke-opacity=".65"/>
      <circle cx="92" cy="295" r="15" fill="$accent2"/><text x="118" y="301" font-size="15" font-weight="850" fill="#fff">$l1</text>
      <rect x="58" y="354" width="202" height="66" rx="16" fill="#ffffff" fill-opacity=".09" stroke="#ff3b30" stroke-opacity=".65"/>
      <circle cx="92" cy="387" r="15" fill="#ff3b30"/><text x="118" y="393" font-size="15" font-weight="850" fill="#fff">$l2</text>
      <rect x="58" y="446" width="228" height="66" rx="16" fill="#ffffff" fill-opacity=".09" stroke="#ffffff" stroke-opacity=".24"/>
      <circle cx="92" cy="479" r="15" fill="#fff" fill-opacity=".2"/><text x="118" y="485" font-size="15" font-weight="850" fill="#fff">$l3</text>
    </g>
  </g>
  $motif
...
{
    return <<<CSS
:root{--black:#000;--white:#fff;--red:#ff3b30;--blue:#2aa8ff;--ink:#09111f;--muted:#536173;--line:#d9e2ec;--surface:#f4f7fb;--surface-2:#eaf6ff;--navy:#020817;--navy-2:#071a30;--accent:$accent;--accent-2:$accent2;--shadow:0 18px 42px rgba(8,20,36,.14);--radius:8px;--max:1180px}*{box-sizing:border-box}html{scroll-behavior:smooth;overflow-x:hidden}body{margin:0;color:var(--ink);background:#fff;font-family:"Segoe UI",Inter,Arial,sans-serif;line-height:1.55;overflow-x:hidden}body.nav-open{overflow:hidden}a{color:inherit;text-decoration:none}img{display:block;max-width:100%;height:auto}.container{width:min(100% - 42px,var(--max));margin-inline:auto}.skip-link{position:absolute;left:-999px}.skip-link:focus{left:12px;top:12px;z-index:1000;padding:10px 14px;color:#fff;background:#000}.site-header{position:sticky;top:0;z-index:100;background:#fff;border-bottom:1px solid var(--line);box-shadow:0 10px 28px rgba(15,23,42,.06)}.header-inner{display:grid;grid-template-columns:auto 1fr auto auto;align-items:center;gap:24px;min-height:78px}.brand img{width:clamp(168px,15vw,226px)}.site-nav{justify-self:center}.nav-menu{display:flex;gap:28px;align-items:center;padding:0;margin:0;list-style:none}.nav-menu a{position:relative;font-size:14px;font-weight:850}.nav-menu a:after{content:"";position:absolute;left:0;right:0;bottom:-10px;height:2px;background:var(--accent);transform:scaleX(0);transition:transform .18s ease}.nav-menu a:hover:after{transform:scaleX(1)}.nav-toggle{display:none}.button{display:inline-flex;align-items:center;justify-content:center;min-height:44px;padding:11px 18px;border-radius:6px;border:0;font-weight:900;line-height:1.1;cursor:pointer}.button-primary{color:#fff;background:linear-gradient(135deg,var(--red),#dc1f18);box-shadow:0 14px 28px rgba(255,59,48,.22)}.button-secondary{color:#fff;background:linear-gradient(135deg,var(--accent),var(--accent-2));box-shadow:0 14px 28px color-mix(in srgb,var(--accent) 24%,transparent)}.button-outline{color:#081525;border:1px solid rgba(8,21,37,.62);background:#fff}.hero-outline{color:#fff;border-color:rgba(255,255,255,.55);background:rgba(255,255,255,.06)}.eyebrow{display:inline-flex;align-items:center;gap:12px;margin:0 0 12px;color:var(--accent);font-size:12px;font-weight:950;letter-spacing:.04em;text-transform:uppercase}.eyebrow:after{content:"";width:42px;height:2px;background:currentColor}.hero{position:relative;display:grid;grid-template-columns:minmax(0,1fr) minmax(390px,530px);gap:42px;align-items:center;min-height:520px;padding:clamp(44px,5vw,72px) max(24px,calc((100vw - var(--max))/2));overflow:hidden;background:radial-gradient(circle at 78% 30%,color-mix(in srgb,var(--accent) 38%,transparent),transparent 31%),linear-gradient(112deg,#020817 0%,#071426 54%,#08233f 100%)}.hero:before{content:"";position:absolute;right:-9%;bottom:-44%;width:48%;height:420px;background:linear-gradient(125deg,color-mix(in srgb,var(--accent) 68%,transparent),color-mix(in srgb,var(--accent-2) 66%,transparent));clip-path:polygon(28% 0,100% 0,73% 100%,0 100%);opacity:.46}.hero-copy,.hero-visual{position:relative;z-index:1;min-width:0}.hero h1,.page-hero h1{max-width:850px;margin:0 0 16px;font-size:clamp(36px,4.7vw,58px);line-height:1.04;letter-spacing:0;overflow-wrap:break-word}.hero h1{color:#fff}.hero p{max-width:710px;margin:0;color:rgba(255,255,255,.88);font-size:clamp(17px,1.45vw,20px)}.actions{display:flex;flex-wrap:wrap;gap:14px;margin-top:24px}.hero-proof{display:flex;flex-wrap:wrap;gap:12px;margin-top:24px}.hero-proof span{display:inline-flex;align-items:center;gap:8px;color:rgba(255,255,255,.86);font-size:13px;font-weight:850}.hero-proof span:before{content:"";width:8px;height:8px;border-radius:50%;background:var(--accent)}.visual-card{margin:0;padding:0;border:1px solid rgba(148,163,184,.28);border-radius:14px;background:rgba(255,255,255,.05);box-shadow:var(--shadow);overflow:hidden;line-height:0}.visual-card img{width:100%;border-radius:14px}.hero-visual .visual-card{background:rgba(255,255,255,.08);backdrop-filter:blur(8px)}.section{padding:clamp(40px,5vw,72px) 0}.section h2{margin:0 0 14px;color:#000;font-size:clamp(28px,3.15vw,40px);line-height:1.12;overflow-wrap:break-word}.section h3{margin:0 0 9px;color:#000;font-size:18px;line-height:1.2;overflow-wrap:break-word}.section p{color:var(--muted)}.section-heading{max-width:720px}.section-heading.centered{max-width:820px;margin:0 auto 28px;text-align:center}.section-heading.centered .eyebrow{justify-content:center}.service-strip{background:#fff}.feature-dark{position:relative;color:#fff;background:linear-gradient(124deg,#020817,#061426 55%,#071f38);overflow:hidden}.feature-dark:before{content:"";position:absolute;inset:0;background:radial-gradient(circle at 78% 30%,color-mix(in srgb,var(--accent) 24%,transparent),transparent 34%),linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px),linear-gradient(0deg,rgba(255,255,255,.035) 1px,transparent 1px);background-size:auto,36px 36px,36px 36px}.feature-layout{position:relative;display:grid;grid-template-columns:1fr minmax(360px,540px);gap:42px;align-items:center}.feature-dark h2,.feature-dark h3,.feature-dark p,.trust-wall h2,.trust-wall h3,.trust-wall p,.process-band h2,.process-band h3,.process-band p,.final-cta h2,.final-cta p{color:#fff}.feature-dark .visual-card{box-shadow:0 24px 56px rgba(0,0,0,.32)}.process-light{background:linear-gradient(180deg,#fff 0%,#f1f6fb 100%)}.industry-band,.color-band{background:linear-gradient(132deg,color-mix(in srgb,var(--accent) 12%,#fff),#fff 48%,color-mix(in srgb,var(--accent-2) 16%,#fff))}.page-hero{padding:clamp(40px,5vw,64px) 0;background:linear-gradient(114deg,#fff 0%,#f7fbff 45%,color-mix(in srgb,var(--accent) 14%,#fff) 100%);border-bottom:1px solid var(--line)}.page-hero-grid,.visual-split,.contact-grid{display:grid;grid-template-columns:1fr minmax(340px,480px);gap:34px;align-items:center}.visual-split.reverse{grid-template-columns:minmax(340px,500px) 1fr}.page-hero p{max-width:760px;margin:0;color:#243044;font-size:18px}.card-grid,.related-grid,.news-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:24px}.service-grid{grid-template-columns:repeat(3,1fr)}.service-card,.related-card,.news-card,.contact-form,.contact-panel,.cta-card,.belief-grid article,.journey-grid article,.service-deep-card,.faq-grid article,.featured-article,.newsletter-card{padding:24px;border:1px solid var(--line);border-radius:var(--radius);background:#fff;box-shadow:0 10px 26px rgba(15,23,42,.07)}.service-card,.related-card,.news-card,.service-deep-card{border-top:4px solid var(--accent);transition:transform .18s ease,box-shadow .18s ease}.service-card:hover,.related-card:hover,.news-card:hover,.service-deep-card:hover{transform:translateY(-3px);box-shadow:var(--shadow)}.service-card p,.related-card p,.news-card p,.service-deep-card p{font-size:14.5px}.service-icon{display:inline-grid;place-items:center;min-width:42px;height:38px;margin-bottom:13px;padding:0 9px;color:#fff;background:linear-gradient(135deg,var(--accent),var(--accent-2));border-radius:8px;font-size:12px;font-weight:950}.benefit-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px;margin-top:24px}.benefit-grid article{padding:16px;border:1px solid color-mix(in srgb,var(--accent) 24%,var(--line));border-radius:8px;background:rgba(255,255,255,.78)}.benefit-grid h3{font-size:15px}.benefit-grid p{margin-bottom:0;font-size:13.5px}.dark-benefits article{background:rgba(255,255,255,.07);border-color:rgba(255,255,255,.12);backdrop-filter:blur(6px)}.timeline{display:grid;grid-template-columns:repeat(5,1fr);gap:16px}.timeline article{padding:20px 12px;text-align:center}.timeline span{display:inline-grid;place-items:center;width:58px;height:58px;margin-bottom:13px;color:#fff;border-radius:50%;background:linear-gradient(135deg,var(--accent),var(--accent-2));font-weight:950;box-shadow:0 12px 22px color-mix(in srgb,var(--accent) 25%,transparent)}.timeline h3{font-size:15px}.timeline p{font-size:13.5px}.process-band{background:#020817}.timeline-dark article{border:1px solid rgba(255,255,255,.12);border-radius:8px;background:rgba(255,255,255,.05)}.trust-wall{padding:44px 0;color:#fff;background:radial-gradient(circle at 18% 20%,color-mix(in srgb,var(--accent) 20%,transparent),transparent 32%),#020817}.trust-wall .section-heading{margin-bottom:22px}.trust-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}.trust-grid article{display:flex;gap:14px;min-height:104px;padding:18px;border:1px solid rgba(255,255,255,.14);border-radius:8px;background:rgba(255,255,255,.055)}.trust-grid span{display:grid;place-items:center;min-width:42px;height:42px;border-radius:8px;color:#fff;background:linear-gradient(135deg,var(--accent),var(--accent-2));font-size:11px;font-weight:950}.trust-grid strong{display:block;margin-bottom:5px;color:#fff}.trust-grid p{margin:0;color:rgba(255,255,255,.72);font-size:13.5px}.related-solutions{background:#fff}.related-card a,.news-card a{display:inline-flex;margin-top:8px;color:#005bd8;font-weight:900}.final-cta{background:#000}.cta-card,.newsletter-card{display:flex;align-items:center;justify-content:space-between;gap:24px}.final-cta .cta-card{color:#fff;background:linear-gradient(100deg,#000,#06233f 55%,color-mix(in srgb,var(--accent) 30%,#06233f));border-color:#1f2937}.belief-grid{display:grid;grid-template-columns:1.15fr 1fr 1fr;gap:18px}.belief-grid article:first-child{background:linear-gradient(130deg,color-mix(in srgb,var(--accent) 12%,#fff),#fff)}.muted{background:#f4f7fb}.journey-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:14px}.journey-grid span{display:inline-flex;margin-bottom:10px;color:var(--red);font-weight:950}.service-detail-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:18px}.service-deep-card{display:grid;gap:12px}.service-deep-card ul{padding-left:20px;margin:0;color:#3d4858}.service-deep-card li{margin:7px 0}.pill-list{display:flex;flex-wrap:wrap;gap:10px;margin-top:20px}.pill-list span,.filter-row span{padding:8px 12px;border:1px solid color-mix(in srgb,var(--accent) 30%,var(--line));border-radius:999px;background:#fff;color:#102033;font-size:13px;font-weight:850}.faq-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:16px}.filter-row{display:flex;flex-wrap:wrap;gap:10px;margin-bottom:22px}.featured-article{display:grid;grid-template-columns:1fr minmax(300px,430px);gap:28px;align-items:center;margin-bottom:22px;background:linear-gradient(130deg,#fff,color-mix(in srgb,var(--accent) 9%,#fff))}.contact-form{display:grid;grid-template-columns:repeat(2,1fr);gap:16px}.contact-panel{background:linear-gradient(140deg,#fff,color-mix(in srgb,var(--accent) 8%,#fff))}label{display:grid;gap:8px;font-weight:800}input,textarea{width:100%;padding:12px 14px;font:inherit;border:1px solid #cbd5e1;border-radius:6px;background:#fff}input:focus,textarea:focus{outline:3px solid color-mix(in srgb,var(--accent) 24%,transparent);border-color:var(--accent)}.full{grid-column:1/-1}.site-footer{position:relative;color:#fff;background:#020817;overflow:hidden}.site-footer:before{content:"";position:absolute;inset:0;background:radial-gradient(circle at 78% 15%,color-mix(in srgb,var(--accent) 20%,transparent),transparent 32%);pointer-events:none}.footer-grid{position:relative;display:grid;grid-template-columns:1.25fr .75fr 1fr 1fr;gap:30px;padding:38px 0 26px}.footer-logo-panel{display:inline-flex;align-items:center;justify-content:center;padding:10px 12px;margin-bottom:14px;border-radius:8px;background:#fff;box-shadow:0 14px 34px rgba(0,0,0,.26)}.footer-logo-panel img{width:190px}.footer-grid p{color:rgba(255,255,255,.76);margin-top:0}.footer-grid a{display:block;margin:0 0 7px;color:rgba(255,255,255,.82)}.footer-grid h3{margin:0 0 12px;color:#fff}.footer-contact .button{display:inline-flex;margin-top:6px}.footer-bottom{position:relative;border-top:1px solid rgba(255,255,255,.12);padding:14px 0 18px}.footer-bottom p{margin:0;color:rgba(255,255,255,.62);font-size:13px}@media(max-width:1180px){.footer-grid{grid-template-columns:1fr 1fr}}@media(max-width:980px){.hero,.page-hero-grid,.visual-split,.visual-split.reverse,.contact-grid,.feature-layout,.featured-article{grid-template-columns:1fr}.hero-visual{max-width:620px}.card-grid,.related-grid,.news-grid,.service-grid,.service-detail-grid,.belief-grid,.faq-grid{grid-template-columns:repeat(2,1fr)}.timeline,.journey-grid{grid-template-columns:repeat(2,1fr)}.trust-grid{grid-template-columns:1fr 1fr}}@media(max-width:760px){.container{width:min(100% - 28px,var(--max))}.header-inner{grid-template-columns:auto auto;min-height:72px}.brand img{width:168px}.header-cta{display:none}.nav-toggle{display:inline-grid;justify-self:end;gap:4px;width:44px;height:42px;padding:10px;border:1px solid var(--line);border-radius:6px;background:#fff}.nav-toggle span{height:2px;background:#000}.site-nav{display:none;grid-column:1/-1;justify-self:stretch}.nav-open .site-nav{display:block}.nav-menu{flex-direction:column;align-items:flex-start;gap:14px;padding:14px 0 18px}.hero{min-height:auto;padding:40px 14px}.hero:before{opacity:.22}.hero-visual{display:none}.hero h1,.page-hero h1{font-size:clamp(31px,8.5vw,40px);line-height:1.08;overflow-wrap:anywhere}.hero p,.page-hero p{font-size:17px}.section{padding:40px 0}.service-grid,.card-grid,.related-grid,.news-grid,.service-detail-grid,.belief-grid,.faq-grid,.benefit-grid,.trust-grid,.timeline,.journey-grid,.footer-grid{grid-template-columns:1fr}.contact-form{grid-template-columns:1fr}.cta-card,.newsletter-card{align-items:flex-start;flex-direction:column}.footer-logo-panel img{width:178px}}
.visual-card{aspect-ratio:11/7}.visual-card img{width:100%;height:100%;object-fit:cover}
CSS;
}
...
function websiteAudit(string $slug, array $brand): string
{
    ...
    return "# Website Audit - {$brand['name']}\n\n" .
        ...
        "### {$date} - Plesk preview layout needed stabilization before deployment\n" .
        "- Severity: High\n" .
        ...
        "### {$date} - Lazy SVG visuals caused reload-time layout shifts\n" .
        "- Severity: High\n" .
...
function pleskPreviewAudit(string $slug, array $brand): string
{
    $date = '2026-06-03';
    return "# Plesk Preview Audit - {$brand['name']}\n\n" .
        "Date: {$date}\n\n" .
        "Purpose: stabilize Plesk preview rendering before deployment so the site loads consistently at the real domain and at preview URLs such as `/plesk-site-preview/{$brand['domain']}/`.\n\n" .
        "## Problems Found\n\n" .
        ...
        "- Preview path simulation: helper output must include `/plesk-site-preview/{$brand['domain']}/` for preview requests.\n" .
...
{
    $lines = ["# BTP Brand Websites", "", "Separate deploy-root PHP websites generated from one BTP design system.", "", "Each site includes website audit, Plesk preview audit, competitive benchmark, content-source, and QOS documentation under `docs/`.", ""];
    foreach ($brands as $slug => $brand) {
