# Deployment - BTP TechAdvisors

## GitHub Push

```powershell
git add .
git commit -m "Update TechAdvisors website"
git push origin deploy-techadvisors
```
...
3. Use the `deploy-techadvisors` repository branch for this site.
