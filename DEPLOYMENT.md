# Deployment - BTP DatastAIsis

## GitHub Push

```powershell
git add .
git commit -m "Update DatastAIsis website"
git push origin deploy-datastaisis
```
...
3. Use the `deploy-datastaisis` repository branch for this site.
